...
int main(void)
{
	...
	docmd(sc, 0x00, 0xb2, 0x01, (0x01 << 3) | 0x04, 0, NULL);
	docmd(sc, 0x00, 0xb2, 0x02, (0x01 << 3) | 0x04, 0, NULL);
...
//	docmd(sc, 0x00, 0xa4, 0x04, 0x00, sizeof(cmd3), cmd3);
	...
	docmd(sc, 0x00, 0xb2, 0x01, 0x08 | 0x04, 0, NULL);
	docmd(sc, 0x00, 0xb2, 0x01, 0x30 | 0x04, 0, NULL);
	docmd(sc, 0x00, 0xb2, 0x01, 0x10 | 0x04, 0, NULL);
	docmd(sc, 0x00, 0xb2, 0x02, 0x10 | 0x04, 0, NULL);
	docmd(sc, 0x00, 0xb2, 0x03, 0x10 | 0x04, 0, NULL);
	docmd(sc, 0x00, 0xb2, 0x04, 0x10 | 0x04, 0, NULL);
	docmd(sc, 0x00, 0xb2, 0x05, 0x10 | 0x04, 0, NULL);
	docmd(sc, 0x00, 0xb2, 0x01, 0x18 | 0x04, 0, NULL);
	docmd(sc, 0x00, 0xb2, 0x02, 0x18 | 0x04, 0, NULL);
